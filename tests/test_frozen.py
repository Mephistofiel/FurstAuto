...
def test_text(browser):
    page = TextsPage(browser, json_file='data.json', url='file:///C:/HTML/Mostbet/(MB)%20frozen_account_RU.html')
    page.open_page()
...
def test_links(browser):
    page = LinksPage(browser, json_file='data.json', url='file:///C:/HTML/Mostbet/(MB)%20frozen_account_RU.html')
    page.open_page()
...
def test_images(browser):
    page = ImagesPage(browser, json_file='data.json', url='file:///C:/HTML/Mostbet/(MB)%20frozen_account_RU.html')
    page.open_page()
...
def test_navigate(browser):
    page = NavigationPage(browser, json_file='data.json', url='file:///C:/HTML/Mostbet/(MB)%20frozen_account_RU.html')
    page.open_page()
